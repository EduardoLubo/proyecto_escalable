...
const DetailCustomerModal = ({ show, onClose, customer, onEdit }) => {
            ...
            <div className="p-4">
                ...
                <ModalBody className="max-h-[75vh] overflow-y-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
                        ...
                        <div>
                            <Label htmlFor="operativoDetail" value="Operativo PSM" className="mb-2 block" />
                            <TextInput
                                id="operativoDetail"
                                type="text"
                                value={customer.operativo ? "SI" : "NO"}
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
