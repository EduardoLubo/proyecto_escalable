...
const Suppliers = () => {
    ...
    const [selectedDetailSupplier, setSelectedDetailSupplier] = useState(null);
    ...
    const fetchSuppliers = async (currentPage = 1) => {
        try {
            ...
            const { data } = await axios.get(`${BASE_URL}api/v1/proveedor?${queryParams}`, {
                headers: {
    ...
    const table = useMaterialReactTable({
        ...
        muiTableBodyCellProps: ({ cell, table }) => ({
            onClick: () => {
                ...
                setSelectedDetailSupplier(cell.row.original);
        ...
        <div className="rounded-xl dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 relative w-full break-words">
            ...
            <DeleteSupplierModal
                ...
                onDeleted={async () => {
                    ...
                    const newPage = (suppliers.length === 1 && page > 1) ? page - 1 : page;
                    setPage(newPage);
                    await fetchSuppliers(newPage);
                }}
                onError={() => {
                    setIsModalDeleteOpen(false);
                    setSupplierToDelete(null);
            ...
            <DetailSupplierModal
                ...
                onEdit={() => {
                    setIsModalDetailOpen(false);
                    setSupplierToEdit(selectedDetailSupplier);
                    setIsModalEditOpen(true);
                }}
            />
