...
const DetailConstructionModal = ({ show, onClose, construction, onEdit }) => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                        <div>
                            ...
                            <TextInput
                                id="estadoDetail"
                                type="text"
                                value={construction.activo ? "ACTIVO" : "INACTIVO"}
                                readOnly
                        ...
                        <div>
                            ...
                            <TextInput
                                id="clienteDetail"
                                type="text"
                                value={construction.cliente?.descripcion || "S/D"}                                
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
                        <div>
                            ...
                            <TextInput
                                id="codigoDetail"
                                type="text"
                                value={construction.codigo}
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
                        <div>
                            <Label htmlFor="pepDetail" value="Pep" className="mb-2 block" />
                            <TextInput
                                id="pepDetail"
                                type="text"
                                value={construction.pep || "S/D"}
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
                        <div>
                            <Label htmlFor="reservaDetail" value="Reserva" className="mb-2 block" />
                            <TextInput
                                id="reservaDetail"
                                type="text"
                                value={construction.reserva || "S/D"}
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
                        <div>
                            <Label htmlFor="zonaDetail" value="Zona" className="mb-2 block" />
                            <TextInput
                                id="zonaDetail"
                                type="text"
                                value={construction.zona || "S/D"}                                
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
                        <div className="lg:col-span-2">
                            ...
                            <TextInput
                                ...
                                type="text"
                                value={construction.descripcion}
                                readOnly
                                className="form-control form-rounded-xl bg-gray-50 rounded-md"
                            />
                        </div>
...
export default DetailConstructionModal;