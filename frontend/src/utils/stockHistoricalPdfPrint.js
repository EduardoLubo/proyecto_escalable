...
export const handleOpenPDF = async ({ userData, stocks, getUbicacionDescripcionFromCache, getCuadrillaDescripcionFromCache, codigoFilter, serieFilter, descripcionFilter, clienteFilter }) => {
    ...
    pdf.text(`SERIALIZADOS`, colRight, 18, { align: "right" });
    ...
    const datos = [
        ...
        ["Cliente", clienteFilter || "S/D"],
        ["Codigo", codigoFilter || "S/D"],
        ["Serie", serieFilter || "S/D"],
        ["Descripción", descripcionFilter || "S/D"],
    ...
    autoTable(pdf, {
        startY: tableStartY,
        head: [["Cliente", "Ubicación", "Cuadrilla", "Código", "Serie", "Descripción", "Estado"]],
        body: tableBody,
        headStyles: {
