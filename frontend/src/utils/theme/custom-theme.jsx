const customTheme = {
  ...
  modal: {
    ...
    content: {
      ...
      inner:
        "relative flex max-h-[90dvh] flex-col rounded-xl bg-white dark:bg-darkgray",
    },
    sizes: {
      sm: "max-w-sm",
      md: "max-w-md",
  ...
  table: {
    ...
    head: {
      ...
      cell: {
        base: "font-semibold px-4 py-3 dark:bg-transparent",
      },
    },
    body: {
      base: "group/body",
  ...
  alert: {
    base: "flex flex-col gap-2 p-8 text-sm shadow-md",
